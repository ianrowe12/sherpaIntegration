        ...
        <View style={styles.container}>
          ...
          <View
            style={[
              ...
              keyboardVisible && {bottom: keyboardOffset + 24},
            ]}>
            <View style={styles.promptHeader}>
              <Text style={styles.promptInputLabel}>
                {l10n.video.promptLabel ?? 'Prompt'}
              </Text>
              <TouchableOpacity
                onPress={Keyboard.dismiss}
                style={styles.promptDismissButton}
                accessibilityRole="button"
                accessibilityLabel={l10n.common.close}>
                <Icon
                  name="keyboard-outline"
                  style={styles.promptDismissIcon}
                />
              </TouchableOpacity>
            </View>
            <TextInput
              ...
              editable={!!onPromptTextChange}
              placeholder={
                l10n.video.promptPlaceholder ?? 'Describe what to analyze'
              }
